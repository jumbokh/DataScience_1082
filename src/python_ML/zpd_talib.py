...
文件名:zpd_talib.py
默认缩写：zta,示例：import zpd_talib as zta

    
【简介】
    zQuant.cn 极宽·量化版的talib函数封装，第一批以pandas_talib.py的29个函数为蓝本。
    zpd_talib函数库v0.5版，所有33个函数，均已测试通过，
    运行平台：python3.5，zwPython2016m2 以上版本   
